...
export default function EditCoursePage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    const fetchCourse = async () => {
      try {
        ...
        const courseData = await adminService.getCourse(params.id, true);
  ...
  const handleSaveCourse = async (updatedCourse: Course) => {
    try {
      ...
      await adminService.updateCourse(updatedCourse.id, updatedCourse);
    ...
    <div className="container mx-auto p-6">
      ...
      <div className="mt-6">
        {editMode === 'quick' ? (
          ...
          <div>
            <Card className="p-6">
              <CourseWizardProvider initialData={course}>
                <CourseWizard 
                  isEditing={true}
