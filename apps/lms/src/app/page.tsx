...
export default function AuthPage() {
  ...
  // Form states - separate states for login and register forms to avoid unnecessary re-renders
  ...
  const handleRegisterChange = useCallback((e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setRegisterForm(prev => ({
      ...prev,
      [id === 'name' ? 'name' : id === 'register-email' ? 'email' : 'password']: value
    }));
  }, []);
  ...
  // Optimize tab change by clearing error
    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-background overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          {/* Features - with optimized animations */}
          <div className="space-y-8 my-8">
            {features.map((feature, index) => (
              <motion.div 
                ...
                transition={{ 
                  duration: 0.3, 
                  delay: mounted ? 0.1 + (index * 0.08) : 0,
                  ease: "easeOut" 
                }}
              >
      ...
      >
        <div className="w-full max-w-md">
          ...
          <div className="space-y-6">
            ...
            {/* Login/Register forms with AnimatePresence for smoother transitions */}
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="relative">
                              ...
                              <Input
                                ...
                                className={cn(
                                  "pl-10",
                                  formSubmitted && !loginForm.email && "border-destructive focus-visible:ring-destructive"
                                )}
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="relative">
                              ...
                              <Input
                                ...
                                className={cn(
                                  "pl-10",
                                  formSubmitted && !loginForm.password && "border-destructive focus-visible:ring-destructive"
                                )}
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="relative">
                              ...
                              <Input
                                ...
                                className={cn(
                                  "pl-10",
                                  formSubmitted && !registerForm.name && "border-destructive focus-visible:ring-destructive"
                                )}
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="relative">
                              ...
                              <Input
                                ...
                                className={cn(
                                  "pl-10",
                                  formSubmitted && !registerForm.email && "border-destructive focus-visible:ring-destructive"
                                )}
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="relative">
                              ...
                              <Input
                                ...
                                className={cn(
                                  "pl-10",
                                  formSubmitted && !registerForm.password && "border-destructive focus-visible:ring-destructive"
                                )}
            ...
            <div className="text-center text-sm mt-6 md:hidden">
              {authMode === 'login' ? (
                <p className="text-muted-foreground">
                  ...
                  <Button variant="link" className="p-0 h-auto" onClick={() => handleTabChange('register')}>
                    Sign up
                  </Button>
                </p>
              ) : (
                <p className="text-muted-foreground">
                  ...
                  <Button variant="link" className="p-0 h-auto" onClick={() => handleTabChange('login')}>
                    Sign in
                  </Button>
                </p>
              )}
